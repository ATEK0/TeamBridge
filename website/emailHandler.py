...
class emailSender():
    ...
    def sendEmail_Complete(self, email, username, firstName):

        subject = 'Welcome to TeamGroup!'
        body = ('''
                <!DOCTYPE html>
                <html>
                <head>
                ...
                <body>''' + f'''
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p>Complete your registration <a href="https://codebyateko.com/teamgroup/add-infos" >here</a>.</p>
                        </div>
                        <div class="footer">
